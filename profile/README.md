...
Each repository provides a workflow definition, usable e.g. on public cloud, and provides an estimate of the time and resources needed for a benchmarking process. We envisage implementing workflows using [Argo workflows](https://argoproj.github.io/workflows/) for Kubernetes clusters on public cloud resources, and eventually, [Snakemake](https://snakemake.readthedocs.io/en/stable/) for other executing environments.
